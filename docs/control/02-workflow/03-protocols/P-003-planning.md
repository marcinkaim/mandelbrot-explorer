...
### 2.1. The Container
The Action Plan is a standalone Markdown document. Like the Action Report, it is a **New File Creation** event. Once created, a Plan is considered **Immutable**—if the plan changes significantly during execution, a new Plan file (incremented sequence) should be created to reflect the pivot.
